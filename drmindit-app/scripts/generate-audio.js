/**
 * DRMINDIT — ELEVENLABS AUDIO GENERATOR
...
// --- Script Loader ---
// Dynamically extracts DrMinditSessionScripts from the JS files
function loadAllScripts() {
    ...
    files.forEach(file => {
        ...
        const match = content.match(/const DrMinditSessionScripts = \{([\s\S]*?)\};/);
        if (match) {
            try {
...
// --- Main Loop ---
async function run() {
    console.log('✦ DrMindit Audio Generator Starting...');
